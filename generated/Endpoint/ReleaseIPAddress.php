...
class ReleaseIPAddress extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    {
        return str_replace(array('{instance_id}', '{ipaddress}'), array($this->instance_id, $this->ipaddress), '/v2/instance/{instance_id}/ipaddress/{ipaddress}/release');
    }
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status && 'application/json' === $contentType) {
            throw new \Limestone\SDK\Exception\ReleaseIPAddressBadRequestException($serializer->deserialize($body, 'Limestone\\SDK\\Model\\Result', 'json'));
        }
        if (403 === $status) {
            throw new \Limestone\SDK\Exception\ReleaseIPAddressForbiddenException();
        }
        if (422 === $status) {
            throw new \Limestone\SDK\Exception\ReleaseIPAddressUnprocessableEntityException();
        }
    }
}